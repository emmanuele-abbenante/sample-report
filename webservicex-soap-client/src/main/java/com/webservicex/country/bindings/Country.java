 ...
 * 2017-11-21T14:17:46.776+01:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "country", 
                  wsdlLocation = "file:/mnt/debian/workspace/java/sample-report/webservicex-soap-client/src/main/resources/country.wsdl",
...
public class Country extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/mnt/debian/workspace/java/sample-report/webservicex-soap-client/src/main/resources/country.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Country.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/mnt/debian/workspace/java/sample-report/webservicex-soap-client/src/main/resources/country.wsdl");
        }
        WSDL_LOCATION = url;
    }
